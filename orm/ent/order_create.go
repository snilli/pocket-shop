...
func (_c *OrderCreate) SetRefID(v string) *OrderCreate {
	_c.mutation.SetRefID(v)
	return _c
}

// SetRefSource sets the "ref_source" field.
func (_c *OrderCreate) SetRefSource(v string) *OrderCreate {
...
func (_c *OrderCreate) SetUsedAt(v time.Time) *OrderCreate {
	_c.mutation.SetUsedAt(v)
	return _c
}

// SetNillableUsedAt sets the "used_at" field if the given value is not nil.
func (_c *OrderCreate) SetNillableUsedAt(v *time.Time) *OrderCreate {
	if v != nil {
		_c.SetUsedAt(*v)
	}
	return _c
...
func (_c *OrderCreate) check() error {
	if _, ok := _c.mutation.RefID(); !ok {
		return &ValidationError{Name: "ref_id", err: errors.New(`ent: missing required field "Order.ref_id"`)}
	}
	...
	if _, ok := _c.mutation.RefSource(); !ok {
		return &ValidationError{Name: "ref_source", err: errors.New(`ent: missing required field "Order.ref_source"`)}
	}
